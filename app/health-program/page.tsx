...
export const metadata: Metadata = {
  ...
  description: 'SimHealth Africa Health Program - Improving health delivery across Africa through innovative solutions and partnerships.',
};
  ...
  const relatedProjects = [
    {
      ...
      description: 'Strengthening community health systems through training and capacity building.',
      link: '/our-projects',
    },
    {
      title: 'Healthcare Technology',
      description: 'Implementing digital health solutions for improved patient care.',
      link: '/our-projects',
    },
    {
      title: 'Maternal Health Program',
      description: 'Reducing maternal mortality through improved healthcare access.',
      link: '/our-projects',
    },
  ];
      ...
      <Section backgroundColor="white">
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ 
            ...
            <p>
              The SimHealth Africa Health Program is dedicated to improving health delivery systems across the African continent. 
              We work with governments, healthcare providers, and communities to strengthen health infrastructure, 
              improve service delivery, and enhance health outcomes.
            </p>
            <p>
              Our approach combines evidence-based interventions with innovative solutions to address the unique challenges 
              facing African health systems. We focus on building sustainable capacity, improving quality of care, 
              and ensuring equitable access to essential health services.
            </p>
            <h3 style={{ 
