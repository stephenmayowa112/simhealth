...
export const metadata = {
  ...
  description:
    'Get in touch with SimHealth Africa. Contact us for inquiries about our programs, services, and partnership opportunities.',
}
...
export default function ContactPage() {
  const contactItems = [
    ...
    },
    {
      icon: <LocationIcon />,
      title: 'Address',
      details: ['SimHealth Africa', 'Lagos, Nigeria'],
    },
  ]
      ...
      <Section backgroundColor="green" className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            We'd love to hear from you. Get in touch with us for inquiries about
            our programs, services, and partnership opportunities.
          </p>
        </div>
      </Section>
      ...
      <Section backgroundColor="white">
        <div className={styles.additionalInfo}>
          ...
          <p className={styles.infoText}>
            SimHealth Africa is the Africa Society for Improved Health Delivery.
            We are dedicated to improving healthcare delivery across Africa
            through innovative programs, capacity building, and strategic
            partnerships.
          </p>
          <p className={styles.infoText}>
            Whether you're interested in our programs, seeking consultancy
            services, or exploring partnership opportunities, we're here to
            collaborate with you in advancing healthcare in Africa.
          </p>
        </div>
      </Section>
    </>
