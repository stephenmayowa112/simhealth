  ...
  return (
    <>
      <Section backgroundColor="white">
        <h1 style={{ marginBottom: '32px', fontSize: '40px' }}>
          UI Components Demo
        </h1>

        <h2
          style={{ marginTop: '48px', marginBottom: '24px', fontSize: '32px' }}
        >
          Buttons
        </h2>
        <div
      ...
      <Section backgroundColor="green">
        ...
        <p style={{ fontSize: '16px', lineHeight: '24px' }}>
          This section demonstrates the green background variant. Sections
          automatically handle max-width constraints (1200px) and responsive
          padding.
        </p>
      </Section>
    </>
