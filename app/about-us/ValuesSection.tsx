...
const values = [
  ...
  {
    title: 'Collaboration',
    description: 'We work together with partners and communities to achieve shared health goals.',
    icon: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    title: 'Impact',
    description: 'We focus on measurable outcomes that improve health and wellbeing in communities.',
    icon: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'We build programs that create lasting change and long-term health improvements.',
    icon: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
