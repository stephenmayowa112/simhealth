  ...
  return (
    <Section>
      ...
      <ul style={{ marginLeft: '24px', marginTop: '16px', lineHeight: '1.8' }}>
        ...
        <li>Responsive switching: mobile nav on 320-767px, desktop nav on 768px+</li>
      ...
      <ol style={{ marginLeft: '24px', marginTop: '16px', lineHeight: '1.8' }}>
        <li>On desktop (768px+): Hover over navigation links to see color transitions</li>
        <li>On desktop: Hover over &quot;Programs&quot; to see dropdown menu</li>
        ...
        <li>On mobile: Click &quot;Programs&quot; accordion to expand sub-menu</li>
        <li>On mobile: Click close button or overlay to close drawer</li>
        <li>Resize browser to test responsive switching</li>
      </ol>

      <div style={{ marginTop: '48px', padding: '24px', backgroundColor: '#e8f5dc', borderRadius: '8px' }}>
        <h3>Requirements Validated:</h3>
        <ul style={{ marginLeft: '24px', marginTop: '16px', lineHeight: '1.8' }}>
          <li><strong>4.1:</strong> Navigation provides clear access to all major sections ✓</li>
          <li><strong>4.2:</strong> Hover states provide visual feedback with color transitions ✓</li>
          <li><strong>4.3:</strong> Active page indicator shows current location ✓</li>
          <li><strong>4.4:</strong> Mobile-friendly menu interface implemented ✓</li>
          <li><strong>4.5:</strong> Consistent positioning across all pages (sticky header) ✓</li>
        </ul>
      </div>
    </Section>
  );
