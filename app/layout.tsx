        ...
        <footer className="site-footer">
          ...
          <div className="footer-wave">
            <svg viewBox="0 0 1440 80" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
              <path d="M0,40 C360,80 720,0 1080,40 C1260,60 1380,50 1440,40 L1440,80 L0,80 Z" fill="#0e1c06"/>
            </svg>
          </div>
          <div className="footer-content">
            <div className="footer-section footer-brand">
              <h3 className="footer-logo-text">SimHealth Africa</h3>
              <p className="footer-tagline">Africa Society for Improved Health Delivery</p>
