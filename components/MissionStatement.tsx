      ...
      >
        ...
        <div className={styles.quoteIcon} aria-hidden="true">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14 28C14 22.477 18.477 18 24 18V14C16.268 14 10 20.268 10 28V38H20V28H14Z" fill="currentColor" opacity="0.15"/>
            <path d="M34 28C34 22.477 38.477 18 44 18V14C36.268 14 30 20.268 30 28V38H40V28H34Z" fill="currentColor" opacity="0.15"/>
          </svg>
        </div>
